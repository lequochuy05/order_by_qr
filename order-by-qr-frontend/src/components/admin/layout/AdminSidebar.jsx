...
const AdminSidebar = ({ isOpen }) => {
  ...
  const { user } = useAuth(); // Lấy role: MANAGER hoặc STAFF

  // Định nghĩa danh sách menu khớp với getPageTitle trong Header của bạn
  const menuItems = [
    { 
    ...
    return (
        ...
        >
        {/* 1. Header của Sidebar nên cố định */}
        ...
        {/* 2. Vùng cuộn menu: thêm h-full và overflow-y-auto */}
