...
import { Mail, Phone, Shield, User, Pencil, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-3xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition-all flex flex-col h-full group">
      ...
      <div className="flex justify-between items-start mb-4">
        <div className={`p-2.5 rounded-2xl ${isManager ? 'bg-purple-100 text-purple-600' : 'bg-blue-100 text-blue-600'}`}>
