...
const AddItemModal = ({ isOpen, onClose, table, onSubmit }) => {
            ...
            <div className="bg-white rounded-2xl w-full max-w-5xl h-[90vh] flex shadow-2xl overflow-hidden">
                ...
                <div className="w-[350px] flex flex-col bg-white">
                    ...
                    <div className="p-4 border-t bg-gray-50">
                        ...
                        <button onClick={handleConfirm} className="w-full py-3 bg-orange-500 text-white font-bold rounded-xl hover:bg-orange-600 shadow-lg shadow-orange-200">
                            Xác nhận thêm món
                        </button>
                    </div>
                </div>
