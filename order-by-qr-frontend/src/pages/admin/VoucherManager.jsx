            ...
            return (
              <div key={v.id} className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all">
                ...
                <div className="text-2xl font-black text-orange-600 mb-4">
                  {v.discountPercent ? `${v.discountPercent}%` : `${v.discountAmount?.toLocaleString()}đ`}
                </div>
                {/* ... Thông tin chi tiết ... */}
                <div className="space-y-2 text-xs text-gray-500 mb-6">
                  ...
                  <div className="flex justify-between"><span>Hạn dùng:</span> <span className="font-bold text-gray-700">{v.validTo ? new Date(v.validTo).toLocaleDateString('vi-VN') : 'Vô hạn'}</span></div>
                </div>
