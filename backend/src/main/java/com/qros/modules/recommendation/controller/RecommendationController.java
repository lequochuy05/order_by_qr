...
public class RecommendationController {
        ...
        public ApiResponse<RecommendationResponse> getPersonalizedRecommendations(
                        ...
                        @RequestParam(defaultValue = "5") @Min(value = 1, message = "Limit must be at least 1") @Max(value = 20, message = "Limit cannot exceed 20") int limit) {
                return ApiResponse.success(
                                recommendationService.getPersonalizedRecommendations(context, limit));
        }
        ...
        public ApiResponse<RecommendationResponse> getCrossSellRecommendations(
                        ...
                        @RequestParam(defaultValue = "3") @Min(value = 1, message = "Limit must be at least 1") @Max(value = 20, message = "Limit cannot exceed 20") int limit) {
                return ApiResponse.success(
