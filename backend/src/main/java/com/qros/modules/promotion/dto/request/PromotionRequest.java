...
public record PromotionRequest(
        @NotBlank(message = "Promotion name cannot be empty")
                @Size(max = 150, message = "Promotion name cannot exceed 150 characters")
                String name,
        @NotNull(message = "Discount percentage cannot be empty") @DecimalMin(value = "0.01", message = "Discount percentage must be greater than 0")
