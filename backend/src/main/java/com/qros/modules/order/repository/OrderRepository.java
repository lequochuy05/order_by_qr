...
import com.qros.modules.order.model.Order.OrderStatus;
...
public interface OrderRepository extends JpaRepository<Order, Long>, JpaSpecificationExecutor<Order> {
        ...
        @EntityGraph(attributePaths = { "table", "paidBy", "orderItems", "orderItems.menuItem",
                        "orderItems.menuItem.category", "orderItems.combo", "orderItems.orderItemOptions",
