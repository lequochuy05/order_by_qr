...
public interface OrderRepository extends JpaRepository<Order, Long>, JpaSpecificationExecutor<Order> {
    ...
    List<Order> findActiveByTableIdForUpdate(
            @Param("tableId") Long tableId, @Param("statuses") List<OrderStatus> statuses);
    ...
    Optional<Order> findFirstByTable_TableCodeAndStatusInOrderByCreatedAtDesc(
            String tableCode, Collection<OrderStatus> statuses);
    ...
    Optional<Order> findFirstByTableIdAndStatusInOrderByCreatedAtDesc(Long tableId, List<OrderStatus> statuses);
    ...
    Optional<Order> findFirstByTableSessionIdAndStatusInOrderByCreatedAtDesc(
            Long tableSessionId, List<OrderStatus> statuses);
