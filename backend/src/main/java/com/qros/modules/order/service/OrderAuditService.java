...
public class OrderAuditService {
    ...
    public void recordOrderStatus(Order order, Order.OrderStatus from, Order.OrderStatus to, User changedBy,
            String reason) {
    ...
    public void recordItemStatus(OrderItem item, OrderItem.OrderItemStatus from, OrderItem.OrderItemStatus to,
