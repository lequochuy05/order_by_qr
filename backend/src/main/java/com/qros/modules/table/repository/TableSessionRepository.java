...
public interface TableSessionRepository extends JpaRepository<TableSession, Long> {
    ...
    @EntityGraph(attributePaths = "table")
    Optional<TableSession> findFirstByTableIdAndStatusOrderByOpenedAtDesc(
            Long tableId,
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<TableSession> findStaleOpenSessionsWithoutOrdersForUpdate(
