...
const CategoryModal = ({ isOpen, onClose, onSubmit, editId, catName, setCatName, preview, handleFileChange, isSubmitting }) => {
      ...
      <div className="bg-white rounded-2xl w-full max-w-sm p-6 shadow-2xl animate-in zoom-in duration-200">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button 
            ...
            className={`w-full text-white py-2.5 rounded-lg font-bold transition-all text-sm ${isSubmitting ? 'bg-orange-300 cursor-not-allowed' : 'bg-orange-500 hover:bg-orange-600'}`}
          >
