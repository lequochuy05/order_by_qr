...
const ItemOptionsModal = ({
  ...
  const handleConfirm = () => {
    ...
    if (onFly && item?.img) {
      const el = document.querySelector(`[data-modal-img="${item.id}"]`);
      if (el) {
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  {opt.required && (
                    <span
                      className={`text-xs font-bold px-2 py-0.5 rounded-full uppercase transition-colors ${
                        invalid
