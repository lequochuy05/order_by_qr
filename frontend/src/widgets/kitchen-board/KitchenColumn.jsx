...
const KitchenColumn = ({
    ...
    return (
        <section className={`flex min-h-[520px] flex-col overflow-hidden rounded-2xl border ${classes.column}`}>
            ...
            <div className="flex-1 space-y-3 overflow-y-auto p-3">
                {items.length === 0 ? (
                    <div className="flex min-h-64 flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-white/50 px-4 text-center dark:border-slate-700 dark:bg-slate-900/40">
                        ...
                        <p className="text-sm font-bold text-slate-600 dark:text-slate-300">Không có món trong cột này</p>
