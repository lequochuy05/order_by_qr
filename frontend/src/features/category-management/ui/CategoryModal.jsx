    ...
    <SharedModal isOpen={isOpen} onClose={onClose} className="max-w-lg !p-0">
      ...
      >
        ...
        <div>
          ...
          <textarea
            rows={3}
            maxLength={255}
            className={`w-full px-4 py-3 border rounded-xl outline-none text-sm transition-all resize-none ${
              errors.description
                ? 'border-red-500 focus:ring-red-100'
                : 'border-gray-200 focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500'
            }`}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <label className="flex items-center gap-3 px-4 h-[46px] bg-gray-50 hover:bg-gray-100 rounded-xl cursor-pointer border border-gray-200 transition-colors">
              ...
              />
              <span className="text-sm font-bold text-gray-700">Hiển thị danh mục</span>
            </label>
          </div>
        </div>
        ...
        <div>
          ...
          <div
            className={`relative border-2 border-dashed rounded-2xl p-4 text-center transition-all group ${
              preview
            ...
            {preview ? (
              <div className="relative inline-block">
                ...
                <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity rounded-xl flex items-center justify-center">
                  <label
                    htmlFor="fileInput"
                    className="cursor-pointer bg-white text-gray-700 px-3 py-1.5 rounded-lg text-xs font-bold shadow-lg"
                  >
                    Thay đổi
                  </label>
                </div>
      ...
      <div className="px-6 py-5 border-t bg-gray-50/50 rounded-b-[2rem] flex gap-3 shrink-0">
        ...
        <button
          ...
          className={`flex-[2] py-3 rounded-xl font-bold text-sm shadow-lg transition-all active:scale-95 ${
