    ...
    <SharedModal isOpen={isOpen} onClose={onClose} className="max-w-xl !p-0">
      ...
      >
        <div>
          ...
          <input
            type="text"
            className={`w-full px-5 py-3.5 bg-gray-50 border-2 rounded-2xl outline-none text-sm transition-all font-bold ${
              errors.name
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-1 mb-2 block">
              Giá Combo (Khuyến mãi) <span className="text-red-500">*</span>
            </label>
      ...
      <div className="px-8 py-6 border-t bg-gray-50/50 rounded-b-[2rem] flex gap-4 shrink-0">
        ...
        <button
          ...
          type="submit"
          disabled={!isChanged}
          className={`flex-[2] py-4 rounded-2xl font-black transition-all text-[11px] uppercase tracking-[0.2em] shadow-xl active:scale-95 ${
            !isChanged
