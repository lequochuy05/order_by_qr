      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <KpiCard
              title="Tổng số món đã bán"
              value={kpi.totalDishes}
              icon={<UtensilsCrossed size={20} />}
              color="orange"
            />
            <KpiCard
              title="Tổng SL bán ra"
              value={kpi.totalQty.toLocaleString()}
              icon={<ShoppingBag size={20} />}
              color="blue"
            />
            <KpiCard
              title="Tổng doanh thu món ăn"
              value={fmtVND(kpi.totalRev)}
              icon={<TrendingUp size={20} />}
              color="emerald"
            />
            <KpiCard
              title="Trung bình SL/Món"
              value={kpi.avg}
                  ...
                  {paginatedDishes.map((dish, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Name */}
                        <td className="p-4">
                          <p className="font-semibold text-gray-800 line-clamp-1" title={dish.name}>
                            {dish.name}
                          </p>
                        </td>
                        {/* Category */}
