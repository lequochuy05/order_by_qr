    ...
    <div className="min-h-screen w-full min-w-0 bg-slate-50 p-0 sm:p-3 lg:p-6">
      ...
      {loading ? (
        <div className="p-20 text-center">
          <Loader2 className="animate-spin inline text-orange-500" size={32} />
        </div>
      ) : (
          ...
          <div className="min-w-0 lg:w-2/3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {employees.map((emp, idx) => (
                <div
                  key={`staff-${emp.fullName || idx}`}
                  className="bg-white border border-gray-100 rounded-2xl p-5 hover:shadow-lg transition-all duration-300 relative overflow-hidden group"
                >
                  {/* Huy hiệu Top 1-3 */}
                  {idx < 3 && (
                    <div
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    {emp.avatarUrl ? (
                      ...
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center text-lg font-bold shadow-sm text-white
                                                ${
                                                  idx === 0
                                                    ? 'bg-yellow-500'
                                                    : idx === 1
